...
let Carta_0  = new Carta("Petroleo", 0, 20)

let Carta_1 = new Carta("Urânio", 1, 1)

let Carta_2 = new Carta("Metal", 2, 12)

let Carta_3 = new Carta("Concreto", 3, 10)

let Carta_4 = new Carta("Munição", 4, 8)

let Carta_5 = new Carta("Projeto", 5, 8)

// Construção

let Carta_6 = new Carta("Industria", 6, 8)

let Carta_7 = new Carta("Municipio", 7, 500)

let Carta_8 = new Carta("Oficina", 8, 4)

let Carta_9 = new Carta("Aeroporto", 9, 4)

let Carta_10 = new Carta("Porto", 10, 4)

let Carta_11 = new Carta("Capital", 11, 4)

let Carta_12 = new Carta("Antiaério", 12, 4)

//Adversidade

let Carta_13 = new Carta("Pandemia", 13, 1)

let Carta_14 = new Carta("Crise Econômica", 14, 1)

let Carta_15 = new Carta("Guerra Civíl", 15, 1)

let Carta_16 = new Carta("'I Want You'", 16, 1)

let Carta_17 = new Carta("Avanço na Medicina", 17, 1)

let Carta_18 = new Carta("A União Faz a Força", 18, 1)

//cooperação

let Carta_19 = new Carta("Meteoro", 19, 1)

let Carta_20 = new Carta("Alienigenas", 20, 1)

let Carta_21 = new Carta("Descoberta", 21, 1)

let Carta_22 = new Carta("Apocalipse", 22, 1)

// padrao Boaa

let Carta_23 = new Carta("Ouro", 23, 1)

let Carta_24 = new Carta("Saúde Pública", 24, 1)

let Carta_25 = new Carta("Caridade", 25, 1)

let Carta_26 = new Carta("Caridade Empresarial", 26, 1)

let Carta_27 = new Carta("Safra Boa de Soja", 27, 1)

let Carta_28 = new Carta("Contra Corrupção", 28, 1)

let Carta_29 = new Carta("Saneamento Básico", 29, 1)

let Carta_30 = new Carta("Melhora na Saúde", 30, 1)

let Carta_31 = new Carta("Investir em Medicamentos", 31, 1)
