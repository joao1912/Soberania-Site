...
const Carta_0  = new Carta("Petroleo", 0, 20)

const Carta_1 = new Carta("Urânio", 1, 1)

const Carta_2 = new Carta("Metal", 2, 12)

const Carta_3 = new Carta("Concreto", 3, 10)

const Carta_4 = new Carta("Munição", 4, 8)

const Carta_5 = new Carta("Projeto", 5, 8)

// Construção

const Carta_6 = new Carta("Industria", 6, 8)

const Carta_7 = new Carta("Municipio", 7, 500)

const Carta_8 = new Carta("Oficina", 8, 4)

const Carta_9 = new Carta("Aeroporto", 9, 4)

const Carta_10 = new Carta("Porto", 10, 4)

const Carta_11 = new Carta("Capital", 11, 4)

const Carta_12 = new Carta("Antiaério", 12, 4)
...
const Carta_44 = new Carta("Motor de Dobra Espacial", 44, 1)

const Carta_45 = new Carta("Bomba de Antimatéria", 45, 1)

const Carta_46 = new Carta("Maquina do Tempo", 46, 1)

const Carta_47 = new Carta("Pilula de Imortalidade", 47, 1)

const Carta_48 = new Carta("Protese Avançada", 48, 1)

const Carta_49 = new Carta("Domínio", 49, 1)

const Carta_50 = new Carta("Domínio", 50, 1)

const Carta_51 = new Carta("Domínio", 51, 1)

const Carta_52 = new Carta("Domínio", 52, 1)
...
const Carta_55 = new Carta("Avião de Transporte", 55, 4)
...
const Carta_59 = new Carta("Submarino", 59, 4)

const Carta_60 = new Carta("Navio de Transporte", 60, 4)

const Carta_61 = new Carta("Helicóptero", 61, 4)

const Carta_62 = new Carta("Navio Militar", 62, 4)

const Carta_63 = new Carta("Caça", 63, 4)

const Carta_64 = new Carta("Forças Especiais", 64, 8)
